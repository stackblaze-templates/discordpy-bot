...
[![Weekly Updates](https://img.shields.io/badge/updates-weekly-green)](https://github.com/stackblaze-templates/discordpy-bot/actions)
[![License](https://img.shields.io/github/license/stackblaze-templates/discordpy-bot)](LICENSE)

A Discord bot built with discord.py (Python). Includes a cog-based architecture for organizing commands and event handlers.

> **Credits**: Built on [Discord.py Bot](https://discordpy.readthedocs.io) by [Rapptz](https://github.com/Rapptz/discord.py). All trademarks belong to their respective owners.
...
Found an issue? [Open a ticket](https://github.com/stackblaze-templates/discordpy-bot/issues).
